...
export function ResultsPodium({ topCountries, votes, reactions }: ResultsPodiumProps) {
        ...
        <div className="relative w-full md:w-1/3 h-full">
          <Card className="bg-[#4A1073]/80 backdrop-blur-md border border-white/10 shadow-lg rounded-md overflow-hidden transform transition-all duration-500 hover:scale-105">
            ...
            <CardHeader className="text-center pb-2 bg-gradient-to-b from-[#4A1073] to-[#3D0D5F] text-white border-b border-white/10">
              <CardTitle className="text-3xl text-white uppercase tracking-wider">🥈 2nd Place</CardTitle>
            </CardHeader>
            <CardContent className="text-center py-8 bg-[#4A1073]/80">
              ...
              <div className="text-xl font-bold text-white uppercase tracking-wider">{topCountries[1].name}</div>
              <div className="text-3xl font-bold mt-3 text-[#FF66A3]">{votes[topCountries[1].id] || 0} points</div>
              {reactions[topCountries[1].id] && <div className="text-3xl mt-2">{reactions[topCountries[1].id]}</div>}
            </CardContent>
          </Card>
        </div>
      )}
        ...
        <div className="relative w-full md:w-1/3 h-full md:mb-8 z-10">
          <Card className="bg-[#4A1073]/80 backdrop-blur-md border border-white/10 shadow-lg rounded-md overflow-hidden transform transition-all duration-500 hover:scale-105">
            ...
            <CardContent className="text-center py-10 bg-[#4A1073]/80">
              ...
              <div className="text-2xl font-bold text-white uppercase tracking-wider">{topCountries[0].name}</div>
              <div className="text-4xl font-bold mt-3 text-[#FF0066]">{votes[topCountries[0].id] || 0} points</div>
              {reactions[topCountries[0].id] && <div className="text-4xl mt-2">{reactions[topCountries[0].id]}</div>}
            </CardContent>
          </Card>
        </div>
      )}
        ...
        <div className="relative w-full md:w-1/3 h-full">
          <Card className="bg-[#4A1073]/80 backdrop-blur-md border border-white/10 shadow-lg rounded-md overflow-hidden transform transition-all duration-500 hover:scale-105">
            ...
            <CardHeader className="text-center pb-2 bg-gradient-to-b from-[#2E0A4A] to-[#1F0733] text-white border-b border-white/10">
              <CardTitle className="text-3xl text-white uppercase tracking-wider">🥉 3rd Place</CardTitle>
            </CardHeader>
            <CardContent className="text-center py-8 bg-[#4A1073]/80">
              <div className="text-6xl mb-4 transform transition-all duration-300 hover:scale-110">
                {topCountries[2].flag}
              </div>
              <div className="text-xl font-bold text-white uppercase tracking-wider">{topCountries[2].name}</div>
              <div className="text-3xl font-bold mt-3 text-[#FF66A3]">{votes[topCountries[2].id] || 0} points</div>
              {reactions[topCountries[2].id] && <div className="text-3xl mt-2">{reactions[topCountries[2].id]}</div>}
            </CardContent>
          </Card>
        </div>
      )}
